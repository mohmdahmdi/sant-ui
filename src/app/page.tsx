  ...
  return (
    <main className="container">
      <section className="flex gap-x-6">
        <div className="bg-white shadow-md w-[25%] rounded-2xl p-4 h-[85vh]">
        ...
        <div className="w-[30%] ">
          <p className="mr-6 text-[29px] mt-">
            با <span className="text-secondary-800 text-4xl font-extrabold">سانتال!</span> بهترین ورژن
            خودتان را به نمایش بگذارید
          </p>
          <HeroIcon className="absolute left-0 mt-8"/>
        </div>
      </section>
    </main>
  );
